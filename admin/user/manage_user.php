		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group col-6">
					...
					<input type="text" name="nama" id="nama" class="form-control" value="<?php echo isset($meta['nama']) ? $meta['nama']: '' ?>" required>
				</div>
				<!-- <div class="form-group col-6">
				...
				<div class="form-group col-6">
					...
					<select name="type" id="type" class="custom-select" value="<?php echo isset($meta['type']) ? $meta['type']: '' ?>" required>
						...
						<option value="2" <?php echo isset($type) && $type == 2 ? 'selected': '' ?>>Karyawan</option>
					</select>
				</div>
				<div class="form-group col-6">
		...
		$.ajax({
			...
			success:function(resp){
				...
				if(resp ==1){
					...
					$('#msg').html('<div class="alert alert-danger">Username sudah ada</div>')
