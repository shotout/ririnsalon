...
<div class="card card-outline card-primary">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="?page=user/manage_user" class="btn btn-flat btn-primary"><span class="fas fa-plus"></span>  Tambah data</a>
		</div>
	</div>
	<div class="card-body">
        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped">
				...
				<tbody>
					<?php 
						$i = 1;
						$qry = $conn->query("SELECT *,concat(nama) as name from `admin` where id != '1' order by concat(nama) asc ");
					...
					?>
						<tr>
							...
							<td ><p class="m-0"><?php echo ($row['type'] == 1 )? "Adminstrator" : "Karyawan" ?></p></td>
							<td align="center">
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Yakin ingin menghapus Data Admin?","delete_user",[$(this).attr('data-id')])
		})
